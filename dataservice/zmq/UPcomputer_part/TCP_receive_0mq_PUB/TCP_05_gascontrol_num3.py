...
def tcp_recv_zmq_send(context, sub_server_addr, syncaddr, down_computer_addr, port):
    ...
    while True:
        ...
        if start_flag:
            ...
            b = b + timestample
            socketzmq.send_multipart([b'05',b])
...
if __name__ == '__main__':
    ...
    down_computer_addr = '192.168.127.5'
    ...
    tcp_recv_zmq_send(context,sub_server_addr,syncaddr,down_computer_addr,5005)
    # for i in port:
