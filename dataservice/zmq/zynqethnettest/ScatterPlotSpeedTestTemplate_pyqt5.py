...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pixelModeCheck.setText(QtGui.QApplication.translate("Form", "pixel mode", None))
        self.label.setText(QtGui.QApplication.translate("Form", "Size", None))
        self.randCheck.setText(QtGui.QApplication.translate("Form", "Randomize", None))
        pass
